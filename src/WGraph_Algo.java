...
public class WGraph_Algo implements weighted_graph_algorithms, java.io.Serializable {
     ...
     * ex1.src node to a PriorityQueue and set his tag to zero. After that we start to
     ...
     * @return the length of the shortest path between ex1.src to dest. -1 if isn't a path between ex1.src and dest.
     */
    @Override
     ...
     * @param src  - start node
     * @param dest - end (target) node
     * @return  the the shortest path between ex1.src to dest - as an ordered List of nodes:
     *          ex1.src--> n1-->n2-->...dest
     */
    @Override
